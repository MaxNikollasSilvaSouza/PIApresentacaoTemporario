    ...
    return (
        <div id = "login">
            ...
            <form className="form" onSubmit={handleSubmit}>
                ...
                <div className="field">
                    <label htmlFor="cpf">Mensalidade</label>
                    <input type="number" name="password" id="password" 
                    value={salario} 
                    onChange={(e)=> setSalario(e.target.value)} placeholder="Mensalidade"/>
                ...
                <div className="field">
                    ...
                    value={cargo} 
                    onChange={(e)=> setCargo(e.target.value)} placeholder="Categoria" />
